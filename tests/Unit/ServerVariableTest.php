...
final class ServerVariableTest extends AbstractTestCase
{
    ...
    /**
     * @covers \Ghostwriter\Environment\ServerVariable::__construct
     * @covers \Ghostwriter\Environment\ServerVariable::assertValidName
     * @covers \Ghostwriter\Environment\ServerVariable::assertValidValue
     * @covers \Ghostwriter\Environment\ServerVariable::getName
     * @covers \Ghostwriter\Environment\ServerVariable::getValue
     *
    ...
    private function createVariable(string $name, string $value): ServerVariable
    {
